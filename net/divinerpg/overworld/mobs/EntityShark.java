...
import net.divinerpg.mob.entity.EntityWaterAttackingMob;
...
public class EntityShark extends EntityWaterAttackingMob {
    ...
    public EntityShark(World par1World) {
        super(par1World);
        tasks.addTask(1, new EntityAIWander(this, 0.3));
        tasks.addTask(3, new EntityAIAttackOnCollide(this, EntityPlayer.class, 0.3, false));
        targetTasks.addTask(6, new EntityAIHurtByTarget(this, false));
        targetTasks.addTask(7, new EntityAINearestAttackableTarget(this, EntityPlayer.class, 0, true));
    ...
    protected void applyEntityAttributes()
    {
        ...
        this.setMoveSpeed(0.73000000417232513D);
    ...
    protected void dropFewItems(boolean var1, int var2)
    {
        ...
        {
            this.entityDropItem(new ItemStack(OverworldItemHelper.sharkFin), 0.0F);
        }
    }
}

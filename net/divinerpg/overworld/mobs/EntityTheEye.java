...
import net.divinerpg.helper.AchievementPageDivineRPG;
...
public class EntityTheEye extends EntityModMob
{
    /**
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        this.dropItem(OverworldItemHelper.rupeeIngot.itemID, 1);

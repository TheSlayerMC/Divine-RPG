...
public class EntityHellSpider extends EntityModMob
{
    ...
    protected void attackEntity(Entity var1, float var2)
    {
        if (var2 > 2.0F && var2 < 6.0F && this.rand.nextInt(10) == 0)
        {
            if (this.onGround)
            {
                ...
                this.motionX = var3 / var7 * 0.5D * 0.800000011920929D + this.motionX * 0.20000000298023224D;
                this.motionZ = var5 / var7 * 0.5D * 0.800000011920929D + this.motionZ * 0.20000000298023224D;

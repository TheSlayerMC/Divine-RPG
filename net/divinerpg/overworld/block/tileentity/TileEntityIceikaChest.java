...
public class TileEntityIceikaChest extends TileEntity implements IInventory
{
    ...
    public TileEntityIceikaChest()
    {
        this.cachedChestType = -1;
    }

    @SideOnly(Side.CLIENT)
    public TileEntityIceikaChest(int par1)
    {
    ...
    private void func_90009_a(TileEntityIceikaChest par1TileEntityChest, int par2)
    {
    ...
    {
        if (this.getBlockType() != null && this.getBlockType() instanceof BlockIceChest)
        {
            --this.numUsingPlayers;
            this.worldObj.addBlockEvent(this.xCoord, this.yCoord, this.zCoord, this.getBlockType().blockID, 1, this.numUsingPlayers);
            this.worldObj.notifyBlocksOfNeighborChange(this.xCoord, this.yCoord, this.zCoord, this.getBlockType().blockID);
    ...
    public int getChestType()
    {
        ...
        {
            if (this.worldObj == null || !(this.getBlockType() instanceof BlockIceChest))
            {
                return 0;
            }

            this.cachedChestType = ((BlockIceChest)this.getBlockType()).blockID;
        }

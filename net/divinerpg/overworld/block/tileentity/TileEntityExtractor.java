...
import net.divinerpg.arcana.block.BlockExtractor;
import net.divinerpg.helper.item.ArcanaItemHelper;
import net.divinerpg.recipe.ExtractorRecipes;
...
public class TileEntityExtractor extends TileEntityFurnace implements IInventory
{
    /**
    ...
    public static int getItemBurnTime(ItemStack par0ItemStack)
    {
        ...
        else
        {
            ...
            if (var1 == ArcanaItemHelper.collector.itemID)
                return 100;

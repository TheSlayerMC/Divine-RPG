...
public class WorldGenDivineMinable implements IWorldGenerator
{
    ...
    public void generate(Random var1, int var2, int var3, World var4, IChunkProvider var5, IChunkProvider var6)
    {
        switch (var4.provider.dimensionId)
        {
            ...
            case 1:
                this.generateEnd(var4, var1, var2 * 16, var3 * 16);

            default:
        }
    }
    
    public void generateOre(World var1, Random rand, int y, int Block, int max, int vein){
    ...
    public void generateNether(World var1, Random var2, int var3, int var4)
    {
        ...
        for (var5 = 0; var5 < 5; ++var5)
        {
            ...
            var8 = var4 + var2.nextInt(16);
            (new WorldGenNetherMinable(OverworldBlockHelper.netheriteOre.blockID, 6)).generate(var1, var2, var6, var7, var8);
        }
        ...
        for (var5 = 0; var5 < 5; ++var5)
        {
            ...
            var7 = var2.nextInt(128);
            var8 = var4 + var2.nextInt(16);
            (new WorldGenNetherMinable(OverworldBlockHelper.bloodGemOre.blockID, 6)).generate(var1, var2, var6, var7, var8);
        }
    }
}

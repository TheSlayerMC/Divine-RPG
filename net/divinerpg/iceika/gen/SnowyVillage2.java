...
public class SnowyVillage2 extends WorldGenerator
{
	...
	public boolean generate(World world, Random rand, int i, int j, int k) {
		...
		world.setBlock(i + 3, j + 1, k + 5, IceikaBlockHelper.coalstoneFurnace.blockID);
		...
		world.setBlock(i + 8, j + 1, k + 1, IceikaBlockHelper.iceDoor.blockID, 1, 0);
		world.setBlock(i + 8, j + 1, k + 9, IceikaBlockHelper.iceDoor.blockID, 3, 0);
		world.setBlock(i + 8, j + 2, k + 1, IceikaBlockHelper.iceDoor.blockID, 8, 0);
		world.setBlock(i + 8, j + 2, k + 9, IceikaBlockHelper.iceDoor.blockID, 8, 0);

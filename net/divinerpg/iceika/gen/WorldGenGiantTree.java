...
public class WorldGenGiantTree extends WorldGenerator {
    ...
    public boolean generate(World world, Random rand, int x, int y, int z) {
        ...
        if (world.getBlockId(x, y - 1, z) != IceikaBlockHelper.IceGrass.blockID  || y >= 256 - height - 1)
            return false;

        world.setBlock(x, y - 1, z, IceikaBlockHelper.IceGrass.blockID );
        world.setBlock(x - 1, y - 1, z, IceikaBlockHelper.IceGrass.blockID );
        world.setBlock(x, y - 1, z - 1, IceikaBlockHelper.IceGrass.blockID );
        world.setBlock(x - 1, y - 1, z - 1, IceikaBlockHelper.IceGrass.blockID );
        ...
        for (int i3 = 0; i3 <= k; i3++) {
            ...
            for (int i4 = x - l1; i4 <= x + l1; i4++) {
                ...
                for (int l4 = z - l1; l4 <= z + l1; l4++) {
                    ...
                    {
                    	setBlock(world, i4, k3, l4,
                                IceikaBlockHelper.IceLeaves.blockID);
                        setBlock(world, i4 - 1, k3, l4,
                                IceikaBlockHelper.IceLeaves.blockID);
                        setBlock(world, i4, k3, l4 - 1,
                                IceikaBlockHelper.IceLeaves.blockID);
                        setBlock(world, i4 - 1, k3, l4 - 1,
                                IceikaBlockHelper.IceLeaves.blockID);
                    }
                }
            }
        ...
        for (int l3 = 0; l3 < height - j3; l3++) {
            ...
            {
            	setBlock(world, x, y + l3, z, IceikaBlockHelper.IceLog.blockID);
            	setBlock(world, x - 1, y + l3, z, IceikaBlockHelper.IceLog.blockID);
            	setBlock(world, x, y + l3, z - 1, IceikaBlockHelper.IceLog.blockID);
            	setBlock(world, x - 1, y + l3, z - 1, IceikaBlockHelper.IceLog.blockID);
            }
        }

...
public class SnowyVillage3 extends WorldGenerator
{
	...
	public boolean generate(World world, Random rand, int i, int j, int k) {
		...
		world.setBlock(i + 3, j + 1, k + 5, IceikaBlockHelper.iceDoor.blockID, 1, 0);
		world.setBlock(i + 3, j + 1, k + 6, IceikaBlockHelper.iceDoor.blockID, 2, 0);
		...
		world.setBlock(i + 3, j + 2, k + 5, IceikaBlockHelper.iceDoor.blockID, 8, 0);
		world.setBlock(i + 3, j + 2, k + 6, IceikaBlockHelper.iceDoor.blockID, 9, 0);

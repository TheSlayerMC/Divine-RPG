...
import net.divinerpg.iceika.gen.TeleporterIceika;
...
public class BlockIceikaPortal extends BreakableBase
{

    public BlockIceikaPortal(int par1)
    {
        super(par1, "Iceika", Material.portal, false);
    ...
    public boolean tryToCreatePortal(World par1World, int par2, int par3, int par4)
    {
        ...
        else
        {
            ...
            for (l = 0; l < 2; ++l)
            {
                for (i1 = 0; i1 < 3; ++i1)
                {
                    par1World.setBlock(par2 + b0 * l, par3 + i1, par4 + b1 * l, IceikaBlockHelper.IceikaPortal.blockID, 0, 2);
                }
            }
            return true;
        }
    ...
    public void onNeighborBlockChange(World par1World, int par2, int par3, int par4, int par5)
    {
        ...
        if (par1World.getBlockId(par2, i1 - 1, par4) != Block.blockSnow.blockID)
        {
        ...
        else
        {
            ...
            if (j1 == 3 && par1World.getBlockId(par2, i1 + j1, par4) == Block.blockSnow.blockID)
            {
                ...
                {
                    if ((par1World.getBlockId(par2 + b0, par3, par4 + b1) != Block.blockSnow.blockID || par1World.getBlockId(par2 - b0, par3, par4 - b1) != this.blockID) && (par1World.getBlockId(par2 - b0, par3, par4 - b1) != Block.blockSnow.blockID || par1World.getBlockId(par2 + b0, par3, par4 + b1) != this.blockID))
                    {
                        par1World.setBlockToAir(par2, par3, par4);
                    }
                }
    ...
    public void onEntityCollidedWithBlock(World par1World, int par2, int par3, int par4, Entity par5Entity)
    {
        if ((par5Entity.ridingEntity == null) && (par5Entity.riddenByEntity == null) && ((par5Entity instanceof EntityPlayerMP)))
        {
            ...
            else if (thePlayer.dimension != DimensionConfigHelper.IceikaID)
            {
                thePlayer.timeUntilPortal = 10;
                thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, DimensionConfigHelper.IceikaID, new TeleporterIceika(thePlayer.mcServer.worldServerForDimension(DimensionConfigHelper.IceikaID)));
            }
            else {
                thePlayer.timeUntilPortal = 10;
    ...
    public void randomDisplayTick(World var1, int var2, int var3, int var4, Random var5)
    {
        ...
        for (int var6 = 0; var6 < 4; ++var6)
        {
            ...
            EntityGreenPortalFX var20 = new EntityGreenPortalFX(var1, var7, var9, var11, var13, var15, var17);
    ...
    {
        return IceikaBlockHelper.IceikaPortal.blockID;
    }
}
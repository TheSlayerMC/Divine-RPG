...
public class BlockIceDoor extends Block
{
    ...
    public void registerIcons(IconRegister par1IconRegister)
    {
        ...
        this.field_111044_a[0] = par1IconRegister.registerIcon(Reference.MOD_ID + ":" + "IceDoor" + "_Top");
        this.field_111043_b[0] = par1IconRegister.registerIcon(Reference.MOD_ID + ":" + "IceDoor" + "_Bottom");
    ...
    {
        return (par1 & 8) != 0 ? 0 : (this.blockMaterial == Material.iron ? IceikaItemHelper.IceDoorItem.itemID : IceikaItemHelper.IceDoorItem.itemID);
    }
    ...
    {
        return this.blockMaterial == Material.iron ? IceikaItemHelper.IceDoorItem.itemID : IceikaItemHelper.IceDoorItem.itemID;
    }

...
public class BlockCoalStoneFurnace extends BlockDivineRPGContainer
{
    /**
    ...
    public BlockCoalStoneFurnace(int par1, boolean par2)
    {
    ...
    {
        return IceikaBlockHelper.coalstoneFurnace.blockID;
    }
    ...
    {
        this.blockIcon = par1IconRegister.registerIcon("DivineRPG:CoalStone");
        this.furnaceIconFront = par1IconRegister.registerIcon(this.isActive ? "DivineRPG:CoalStoneFurnace_Front_On" : "DivineRPG:CoalStoneFurnace_Front_Off");
        this.furnaceIconTop = par1IconRegister.registerIcon("DivineRPG:CoalStone");
    }
    ...
    public static void updateFurnaceBlockState(boolean par0, World par1World, int par2, int par3, int par4)
    {
        ...
        if (par0)
        {
            par1World.setBlock(par2, par3, par4, IceikaBlockHelper.coalstoneFurnaceActive.blockID);
        }
        else
        {
            par1World.setBlock(par2, par3, par4, IceikaBlockHelper.coalstoneFurnace.blockID);
        }
    ...
    public void onBlockPlacedBy(World par1World, int par2, int par3, int par4, EntityLiving par5EntityLiving, ItemStack par6ItemStack)
    {
        ...
        {
            ((TileEntityCoalStoneFurnace)par1World.getBlockTileEntity(par2, par3, par4)).func_94129_a(par6ItemStack.getDisplayName());
        }
    }
    ...
    public void breakBlock(World par1World, int par2, int par3, int par4, int par5, int par6)
    {
        ...
        {
            TileEntityCoalStoneFurnace TileEntityCoalstoneFurnace = (TileEntityCoalStoneFurnace)par1World.getBlockTileEntity(par2, par3, par4);

            if (TileEntityCoalstoneFurnace != null)
            {
                for (int j1 = 0; j1 < TileEntityCoalstoneFurnace.getSizeInventory(); ++j1)
                {
                    ItemStack itemstack = TileEntityCoalstoneFurnace.getStackInSlot(j1);

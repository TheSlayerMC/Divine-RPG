...
public class TwilightItemHelper extends HelperBase  {
	...
	//Halite
	public static final Item haliteHelmet = new ItemBaseArmor(x.getID("HaliteHelmet"), haliteArmor, 0, HEAD, true).setDamageReduction(0.2075D).setDescriptors(haliteDesc).setUnlocalizedName("HaliteHelmet").setCreativeTab(DivineRPG.Armor);
	public static final Item haliteBody = new ItemBaseArmor(x.getID("HaliteBody"), haliteArmor, 1, BODY, true).setDamageReduction(0.2075D).setDescriptors(haliteDesc).setUnlocalizedName("HaliteBody").setCreativeTab(DivineRPG.Armor);
	public static final Item haliteLegs = new ItemBaseArmor(x.getID("HaliteLegs"), haliteArmor, 2, LEGS, true).setDamageReduction(0.2075D).setDescriptors(haliteDesc).setUnlocalizedName("HaliteLegs").setCreativeTab(DivineRPG.Armor);
	public static final Item haliteBoots = new ItemBaseArmor(x.getID("HaliteBoots"), haliteArmor, 3, BOOTS, true).setDamageReduction(0.2075D).setDescriptors(haliteDesc).setUnlocalizedName("HaliteBoots").setCreativeTab(DivineRPG.Armor);
	...
	public static final Item MythrilHelmet = new ItemBaseArmor(x.getID("MythrilHelmet"), mythrilArmor, 0, HEAD, true).setDamageReduction(0.1875D).setDescriptors(mythrilDesc).setCreativeTab(DivineRPG.Armor).setUnlocalizedName("MythrilHelmet");
	public static final Item MythrilBoots = new ItemBaseArmor(x.getID("MythrilBoots"), mythrilArmor, 3, BOOTS, true).setDamageReduction(0.1875D).setDescriptors(mythrilDesc).setCreativeTab(DivineRPG.Armor).setUnlocalizedName("MythrilBoots");
	public static final Item Mythrillegs = new ItemBaseArmor(x.getID("MythrilLegs"), mythrilArmor, 2, LEGS, true).setDamageReduction(0.1875D).setDescriptors(mythrilDesc).setCreativeTab(DivineRPG.Armor).setUnlocalizedName("MythrilLegs");
	public static final Item MythrilChest = new ItemBaseArmor(x.getID("MythrilBody"), mythrilArmor, 1, BODY, true).setDamageReduction(0.1875D).setDescriptors(mythrilDesc).setCreativeTab(DivineRPG.Armor).setUnlocalizedName("MythrilBody");
	...
	//Divine
	public static final Item divineHelmet = new ItemBaseArmor(x.getID("DivineHelmet"), divineArmor, 0, HEAD, true).setDamageReduction(0.1875D).setDescriptors(divineDesc).setUnlocalizedName("DivineHelmet").setCreativeTab(DivineRPG.Armor);
	public static final Item divineBody = new ItemBaseArmor(x.getID("DivineBody"), divineArmor, 1, BODY, true).setDamageReduction(0.1875D).setDescriptors(divineDesc).setUnlocalizedName("DivineBody").setCreativeTab(DivineRPG.Armor);
	public static final Item divineLegs = new ItemBaseArmor(x.getID("DivineLegs"), divineArmor, 2, LEGS, true).setDamageReduction(0.1875D).setDescriptors(divineDesc).setUnlocalizedName("DivineLegs").setCreativeTab(DivineRPG.Armor);
	public static final Item divineBoots = new ItemBaseArmor(x.getID("DivineBoots"), divineArmor, 3, BOOTS, true).setDamageReduction(0.1875D).setDescriptors(divineDesc).setUnlocalizedName("DivineBoots").setCreativeTab(DivineRPG.Armor);
	...
	public static final Item DraviteHelmet = new ItemBaseArmor(x.getID("DraviteHelmet"), draviteArmor, 0, HEAD, true).setDamageReduction(0.15D).setDescriptors(draviteDesc).setCreativeTab(DivineRPG.Armor).setUnlocalizedName("DraviteHelmet");
	public static final Item DraviteChest = new ItemBaseArmor(x.getID("DraviteBody"), draviteArmor, 1, BODY, true).setDamageReduction(0.15D).setDescriptors(draviteDesc).setCreativeTab(DivineRPG.Armor).setUnlocalizedName("DraviteChest");
	public static final Item Dravitelegs = new ItemBaseArmor(x.getID("DraviteLegs"), draviteArmor, 2, LEGS, true).setDamageReduction(0.15D).setDescriptors(draviteDesc).setCreativeTab(DivineRPG.Armor).setUnlocalizedName("Dravitelegs");
	public static final Item DraviteBoots = new ItemBaseArmor(x.getID("DraviteBoots"), draviteArmor, 3, BOOTS, true).setDamageReduction(0.15D).setDescriptors(draviteDesc).setCreativeTab(DivineRPG.Armor).setUnlocalizedName("DraviteBoots");
	...
	public static final Item AzuriteHelmet = new ItemBaseArmor(x.getID("AzuriteHelmet"), azuriteArmor, 0, HEAD, true).setDamageReduction(0.1625D).setDescriptors(azuriteDesc).setCreativeTab(DivineRPG.Armor).setUnlocalizedName("AzuriteHelmet");
	public static final Item AzuriteBoots = new ItemBaseArmor(x.getID("AzuriteBoots"), azuriteArmor, 3, BOOTS, true).setDamageReduction(0.1625D).setDescriptors(azuriteDesc).setCreativeTab(DivineRPG.Armor).setUnlocalizedName("AzuriteBoots");
	public static final Item Azuritelegs = new ItemBaseArmor(x.getID("AzuriteLegs"), azuriteArmor, 2, LEGS, true).setDamageReduction(0.1625D).setDescriptors(azuriteDesc).setCreativeTab(DivineRPG.Armor).setUnlocalizedName("Azuritelegs");
	public static final Item AzuriteChest = new ItemBaseArmor(x.getID("AzuriteBody"), azuriteArmor, 1, BODY, true).setDamageReduction(0.1625D).setDescriptors(azuriteDesc).setCreativeTab(DivineRPG.Armor).setUnlocalizedName("AzuriteBody");
	...
	public static final Item AugiteHelmet = new ItemBaseArmor(x.getID("AugiteHelmet"), augiteArmor, 0, HEAD, true).setDamageReduction(0.20D).setDescriptors(augiteDesc).setCreativeTab(DivineRPG.Armor).setUnlocalizedName("AugiteHelmet");
	public static final Item AugiteBoots = new ItemBaseArmor(x.getID("AugiteBoots"), augiteArmor, 3, BOOTS, true).setDamageReduction(0.20D).setDescriptors(augiteDesc).setCreativeTab(DivineRPG.Armor).setUnlocalizedName("AugiteBoots");
	public static final Item Augitelegs = new ItemBaseArmor(x.getID("AugiteLegs"), augiteArmor, 2, LEGS, true).setDamageReduction(0.20D).setDescriptors(augiteDesc).setCreativeTab(DivineRPG.Armor).setUnlocalizedName("AugiteLegs");
	public static final Item AugiteChest = new ItemBaseArmor(x.getID("AugiteBody"), augiteArmor, 1, BODY, true).setDamageReduction(0.20D).setDescriptors(augiteDesc).setCreativeTab(DivineRPG.Armor).setUnlocalizedName("AugiteBody");
	...
	public static final Item UviteHelmet = new ItemBaseArmor(x.getID("UviteHelmet"), UviteArmor, 0, HEAD, true).setDamageReduction(0.18D).setDescriptors(uviteDesc).setCreativeTab(DivineRPG.Armor).setUnlocalizedName("UviteHelmet");
	public static final Item UviteBoots = new ItemBaseArmor(x.getID("UviteBoots"), UviteArmor, 3, BOOTS, true).setDamageReduction(0.18D).setDescriptors(uviteDesc).setCreativeTab(DivineRPG.Armor).setUnlocalizedName("UviteBoots");
	public static final Item Uvitelegs = new ItemBaseArmor(x.getID("UviteLegs"), UviteArmor, 2, LEGS, true).setDamageReduction(0.18D).setDescriptors(uviteDesc).setCreativeTab(DivineRPG.Armor).setUnlocalizedName("UviteLegs");
	public static final Item UviteChest = new ItemBaseArmor(x.getID("UviteBody"), UviteArmor, 1, BODY, true).setDamageReduction(0.18D).setDescriptors(uviteDesc).setCreativeTab(DivineRPG.Armor).setUnlocalizedName("UviteBody");

...
public class OverworldItemHelper extends HelperBase {
	...
	public static final Item aquaticLegs = new ItemBaseArmor(x.getID("AquaticLegs"), aquatic, 2, LEGS, true).setDamageReduction(0.135D).setDescriptors(aquaticDesc).setUnlocalizedName("AquastriveLegs").setCreativeTab(DivineRPG.Armor);
	public static final Item aquaticBoots = new ItemBaseArmor(x.getID("AquaticBoots"), aquatic, 3, BOOTS, true).setDamageReduction(0.135D).setDescriptors(aquaticDesc).setUnlocalizedName("AquastriveBoots").setCreativeTab(DivineRPG.Armor);

	public static final Item eliteRealmiteHelmet = new ItemBaseArmor(x.getID("EliteRealHelmet"), eliteRealmite, 0, HEAD, true).setDamageReduction(0.125D).setDescriptors(eliteRealmiteDesc).setUnlocalizedName("EliteRealmiteHelmet").setCreativeTab(DivineRPG.Armor);
	public static final Item eliteRealmiteBody = new ItemBaseArmor(x.getID("EliteRealBody"), eliteRealmite, 1, BODY, true).setDamageReduction(0.125D).setDescriptors(eliteRealmiteDesc).setUnlocalizedName("EliteRealmiteBody").setCreativeTab(DivineRPG.Armor);
	...
	public static final Item grimReaperLegs = new ItemBaseArmor(x.getID("GrimReaperLegs"), grim, 2, LEGS, true).setDescriptors(skeletonDesc).setUnlocalizedName("SkelemanLegs").setCreativeTab(DivineRPG.Armor);
	public static final Item grimReaperBoots = new ItemBaseArmor(x.getID("GrimReaperBoots"), grim, 3, BOOTS, true).setDescriptors(skeletonDesc).setUnlocalizedName("SkelemanBoots").setCreativeTab(DivineRPG.Armor);

	public static final Item jackOManBoots = new ItemBaseArmor(x.getID("JackOManBoots"), jack, 0, HEAD, true).setDescriptors(jackDesc).setUnlocalizedName("JackOManBoots").setCreativeTab(DivineRPG.Armor);
	public static final Item jackOManLegs = new ItemBaseArmor(x.getID("JackOManLegs"), jack, 1, BODY, true).setDescriptors(jackDesc).setUnlocalizedName("JackOManLegs").setCreativeTab(DivineRPG.Armor);

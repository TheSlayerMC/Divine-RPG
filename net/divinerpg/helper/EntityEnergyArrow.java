...
public class EntityEnergyArrow extends Entity
{
    ...
    public EntityEnergyArrow(World world, EntityLivingBase entityShooter, EntityLivingBase var3, float var4, float var5)
    {
        super(world);
        ...
        this.posY = entityShooter.posY + entityShooter.getEyeHeight() - 0.10000000149011612D;
        double var6 = var3.posX - entityShooter.posX;
        double var8 = var3.posY + var3.getEyeHeight() - 0.699999988079071D - this.posY;
        double var10 = var3.posZ - entityShooter.posZ;
        ...
        if (var12 >= 1.0E-7D)
        {
            ...
            this.setLocationAndAngles(entityShooter.posX + var16, this.posY, entityShooter.posZ + var18, var14, var15);
            this.yOffset = 0.0F;
    ...
    public EntityEnergyArrow(World world, EntityLivingBase entity, float var3)
    {
        super(world);
    ...
    public void onCollideWithPlayer(EntityPlayer var1)
    {
        if (!this.worldObj.isRemote && this.inGround && this.arrowShake <= 0)
        {
            ...
            //if (this.canBePickedUp == 1 && !var1.inventory.addItemStackToInventory(new ItemStack(OverworldItemHelper.AzuriteArrow, 1)))
            {
                var2 = false;
            }
        }

...
public class ItemDualClaw extends ItemDivineRPGSword
{
    private int weaponDamage;
    private final EnumToolMaterial field_40439_b;

    public ItemDualClaw(int var1, EnumToolMaterial var2)
    {
        super(var1, var2);
    ...
    {
        return var2.blockID != Block.sand.blockID ? 1.5F : 15.0F;
    }
    ...
    {
        return var1.blockID == Block.sand.blockID;
    }

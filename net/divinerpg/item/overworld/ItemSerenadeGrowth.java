...
public class ItemSerenadeGrowth extends ItemsBase
{
    ...
    public ItemSerenadeGrowth(int var1)
    {
        super(var1);
        this.maxStackSize = 1;
        this.registerTextures("SerenadeOfGrowth");
    }
    ...
    public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int par4, int par5, int par6, int par7, float par8, float par9, float par10)
    {
        ...
        else
        {
            ...
            {
                if (!par3World.isRemote) {
                    ((BlockMushroom)Block.blocksList[var11]).fertilizeMushroom(par3World, par4, par5, par6, par3World.rand);
                }
            ...
            if (var11 == Block.cocoaPlant.blockID)
            {
                if (!par3World.isRemote)
                {
                    par3World.setBlockMetadataWithNotify(par4, par5, par6, 8 | BlockDirectional.getDirection(par3World.getBlockMetadata(par4, par5, par6)), 3);
                }
                        ...
                        for (var12 = 0; var12 < 128; ++var12)
                        {
                            ...
                            if (par3World.getBlockId(var13, var14, var15) == 0)
                            {
                                if (itemRand.nextInt(10) != 0)
                                {
                                    ...
                                    {
                                        par3World.setBlockMetadataWithNotify(var13, var14, var15, Block.tallGrass.blockID, 1);
                                    }
                                }
                                else
                                {

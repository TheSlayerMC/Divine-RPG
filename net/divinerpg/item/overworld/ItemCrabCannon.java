...
import net.divinerpg.mob.entity.item.EntityCrabCannon;
...
public class ItemCrabCannon extends ItemsBase {
	...
	public ItemCrabCannon(int var1, int var2, int var4, int var5, String var6, String var7) {
		super(var1);
		this.damage = var2;
		this.firemax = var5;
	...
	public ItemStack onItemRightClick(ItemStack var1, World var2, EntityPlayer var3) {
		if (!var2.isRemote && var3.inventory.hasItem(this.clipid)
				|| var3.capabilities.isCreativeMode) {

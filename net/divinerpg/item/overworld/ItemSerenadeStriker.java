...
public class ItemSerenadeStriker extends ItemsBase
{
    ...
    public ItemStack onItemRightClick(ItemStack var1, World var2, EntityPlayer var3)
    {
        ...
        double var8 = var3.posY + 1.62D - var3.yOffset;
        ...
        else
        {
            if (var22.typeOfHit == EnumMovingObjectType.TILE)
            {
                ...
                var2.spawnEntityInWorld(new EntityLightningBolt(var2, var23 + 0.5D, var24 + 0.5D, var25 + 0.5D));
                var3.swingItem();

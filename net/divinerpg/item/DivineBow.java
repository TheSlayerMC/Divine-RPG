...
public class DivineBow extends ItemBow {
	...
	public DivineBow setTexture(String name){
		Name = name;
		return this;
	}
    ...
    public void registerIcons(IconRegister par1IconRegister)
    {
        ...
        this.itemIcon = par1IconRegister.registerIcon(prefix + "Bow_0");
        this.iconArray = new Icon[3];

        this.iconArray[0] = par1IconRegister.registerIcon(prefix + "Bow_1");
        this.iconArray[1] = par1IconRegister.registerIcon(prefix + "Bow_2");
        this.iconArray[2] = par1IconRegister.registerIcon(prefix + "Bow_3");

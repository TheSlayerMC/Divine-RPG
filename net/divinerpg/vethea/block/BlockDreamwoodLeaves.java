...
public class BlockDreamwoodLeaves extends LeavesBase implements IShearable
{
    int[] adjacentTreeBlocks;

    public BlockDreamwoodLeaves(int par1, String par2)
    {
        super(par1, true);
    ...
    public void dropBlockAsItemWithChance(World par1World, int par2, int par3, int par4, int par5, float par6, int par7)
    {
        if (!par1World.isRemote)
        {
            ...
            {
                this.dropBlockAsItem_do(par1World, par2, par3, par4, new ItemStack(TwilightItemHelper.TwilightApple, 1, 0));
            }
        }
    }

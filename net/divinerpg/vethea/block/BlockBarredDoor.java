...
public class BlockBarredDoor extends Block
{
    ...
    public BlockBarredDoor(int par1, Material par2Material, String name)
    {
    ...
    public void registerIcons(IconRegister par1IconRegister)
    {
        ...
        this.field_111044_a[0] = par1IconRegister.registerIcon(Reference.MOD_ID + ":" + Door + "_Top");
        this.field_111043_b[0] = par1IconRegister.registerIcon(Reference.MOD_ID + ":" + Door + "_Bottom");
    ...
    {
        return (par1 & 8) != 0 ? 0 : (this.blockMaterial == Material.iron ? VetheaItemHelper.BarredDoor.itemID : VetheaItemHelper.BarredDoor.itemID);
    }
    ...
    {
        return this.blockMaterial == Material.iron ? VetheaItemHelper.BarredDoor.itemID : VetheaItemHelper.BarredDoor.itemID;
    }

...
import net.divinerpg.vethea.gen.all.WorldGenVetheanFlower;
import net.divinerpg.vethea.gen.all.WorldGenVetheanPillar;
import net.divinerpg.vethea.gen.layer1.Crypt1;
import net.divinerpg.vethea.gen.layer1.Crypt2;
import net.divinerpg.vethea.gen.layer1.Tree4;
import net.divinerpg.vethea.gen.layer1.Tree5;
import net.divinerpg.vethea.gen.layer1.Tree6;
import net.divinerpg.vethea.gen.layer1.WorldGenLayer1;
import net.divinerpg.vethea.gen.layer1.WorldGenLayer1Forest;
import net.divinerpg.vethea.gen.layer2.HiveNest;
import net.divinerpg.vethea.gen.layer2.Pyramid1;
import net.divinerpg.vethea.gen.layer2.Pyramid2;
import net.divinerpg.vethea.gen.layer2.WorldGenLayer2Forest;
import net.divinerpg.vethea.gen.layer3.KarosMadhouse;
import net.divinerpg.vethea.gen.layer3.QuadroticPost;
import net.divinerpg.vethea.gen.layer3.Tree7;
import net.divinerpg.vethea.gen.layer3.Tree8;
import net.divinerpg.vethea.gen.layer3.WorldGenLayer3BigTree;
import net.divinerpg.vethea.gen.layer3.WorldGenLayer3SmallTree;
import net.divinerpg.vethea.gen.layer4.Evergarden;
import net.divinerpg.vethea.gen.layer4.Layer4MassiveTree;
import net.divinerpg.vethea.gen.layer4.RaglokChamber;
import net.divinerpg.vethea.gen.layer4.Tree1;
import net.divinerpg.vethea.gen.layer4.Tree2;
import net.divinerpg.vethea.gen.layer4.WreckHall;
...
public class ChunkProviderVethea implements IChunkProvider
{
	...
	public ChunkProviderVethea(World par1World, long par2, boolean par4)
	{
		...
		ceilingTexture = new WorldGenConeUp(VetheaBlockHelper.dreamStone.blockID, 4);
					...
					for (int var31 = 0; var31 < 8; ++var31)
					{
						...
						for (int var42 = 0; var42 < 4; ++var42)
						{
							...
							for (int var51 = 0; var51 < 4; ++var51)
							{
								if ((var47 += var49) > 0.0D)
								{
									par3ArrayOfByte[var43 += var44] = (byte)VetheaBlockHelper.dreamStone.blockID;
								}
	...
	public void populate(IChunkProvider par1IChunkProvider, int par2, int par3)
	{
        ...
        for (int i = 0; i < 3; i++)
        {
            ...
            (new WorldGenConeUp(0, 4)).generate(this.worldObj, this.rand, var12, var13, var14);
        }

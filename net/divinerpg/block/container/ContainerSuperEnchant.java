...
public class ContainerSuperEnchant extends Container
{
    ...
    public ContainerSuperEnchant(InventoryPlayer par1InventoryPlayer, World par2World, int par3, int par4, int par5)
    {
    ...
    {
       return this.worldPointer.getBlockId(this.posX, this.posY, this.posZ) != OverworldBlockHelper.SuperEnchantmentTable.blockID ? false : par1EntityPlayer.getDistanceSq(this.posX + 0.5D, this.posY + 0.5D, this.posZ + 0.5D) <= 64.0D;
    }

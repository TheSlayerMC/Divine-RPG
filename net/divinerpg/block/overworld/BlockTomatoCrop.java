...
public class BlockTomatoCrop extends BlockFlower
{
    ...
    public BlockTomatoCrop(int par1)
    {
        super(par1);
    ...
    {
        return OverworldItemHelper.tomatoSeeds.itemID;
    }
 
    protected int getCropItem()
    {
        return OverworldItemHelper.tomato.itemID;
    }
    ...
    public void registerIcons(IconRegister par1IconRegister)
    {
        ...
        {
            this.iconArray[i] = par1IconRegister.registerIcon(Reference.MOD_ID + ":" + "TomatoPlant_" + i);
        }
    }
}

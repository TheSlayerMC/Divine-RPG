...
public class BlockLightFenceRed extends BlockDivineRPGFence
{
    private final boolean powered;
    private final String field_94464_a;

    public BlockLightFenceRed(int par1, boolean par2, String par4)
    {
        super(par1, par4);
        this.powered = par2;
    ...
    public void onBlockAdded(World par1, int par2, int par3, int par4)
    {
        if (!par1.isRemote)
        {
            ...
            {
                par1.setBlock(par2, par3, par4, OverworldBlockHelper.lightFenceRedOn.blockID);
            }
        }
    }
    ...
    public void updateTick(World par1, int par2, int par3, int par4, Random par5)
    {
        ...
        {
            par1.setBlock(par2, par3, par4, OverworldBlockHelper.lightFenceRed.blockID);
        }
    }
    ...
    {
        return OverworldBlockHelper.lightFenceRed.blockID;
    }

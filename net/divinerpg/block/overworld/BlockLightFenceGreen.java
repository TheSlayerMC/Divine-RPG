...
public class BlockLightFenceGreen extends BlockDivineRPGFence
{
    private final boolean powered;
    private final String field_94464_a;

    public BlockLightFenceGreen(int par1, boolean par2, String par4)
    {
        super(par1, par4);
        this.powered = par2;
    ...
    public void onBlockAdded(World par1, int par2, int par3, int par4)
    {
        if (!par1.isRemote)
        {
            ...
            {
                par1.setBlock(par2, par3, par4, OverworldBlockHelper.lightFenceGreenOn.blockID);
            }
        }
    }
    ...
    public void updateTick(World par1, int par2, int par3, int par4, Random par5)
    {
        ...
        {
            par1.setBlock(par2, par3, par4, OverworldBlockHelper.lightFenceGreen.blockID);
        }
    }
    ...
    {
        return OverworldBlockHelper.lightFenceGreen.blockID;
    }

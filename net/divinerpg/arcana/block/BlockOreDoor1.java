...
public class BlockOreDoor1 extends BlockBase
{
    ...
    public BlockOreDoor1(int par1, Material par2Material)
    {
    ...
    public void registerIcons(IconRegister par1IconRegister)
    {
        ...
        this.field_111044_a[0] = par1IconRegister.registerIcon("DivineRPG:OreDoor1");
        this.field_111043_b[0] = par1IconRegister.registerIcon("DivineRPG:SoulSludge");
    ...
    {
        return (par1 & 8) != 0 ? 0 : (this.blockMaterial == Material.iron ? ArcanaItemHelper.OreDoor1.itemID : ArcanaItemHelper.OreDoor1.itemID);
    }
    ...
    {
        return this.blockMaterial == Material.iron ? ArcanaItemHelper.OreDoor1.itemID : ArcanaItemHelper.OreDoor1.itemID;
    }

...
public class BlockGreenlightFurnace extends BlockContainer
{
    ...
    public BlockGreenlightFurnace(int par1, boolean par2)
    {
    ...
    {
        return ArcanaBlockHelper.greenlightFurnace.blockID;
    }
    ...
    {
        this.blockIcon = par1IconRegister.registerIcon("DivineRPG:GreenlightFurnace_Side");
        this.furnaceIconFront = par1IconRegister.registerIcon(this.isActive ? "DivineRPG:GreenlightFurnace_On_Front" : "DivineRPG:GreenlightFurnace_Off_Front");
        this.furnaceIconTop = par1IconRegister.registerIcon("DivineRPG:GreenlightFurnace_Top");
    }
    ...
    public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9)
    {
        ...
        {
            TileEntityGreenlightFurnace var10 = (TileEntityGreenlightFurnace)par1World.getBlockTileEntity(par2, par3, par4);
    ...
    public static void updateFurnaceBlockState(boolean par0, World par1World, int par2, int par3, int par4)
    {
        ...
        if (par0)
        {
            par1World.setBlock(par2, par3, par4, ArcanaBlockHelper.greenlightFurnaceOn.blockID);
        }
        else
        {
            par1World.setBlock(par2, par3, par4, ArcanaBlockHelper.greenlightFurnace.blockID);
        }
    ...
    public void breakBlock(World par1World, int par2, int par3, int par4, int par5, int par6)
    {
        ...
        {
            TileEntityGreenlightFurnace var7 = (TileEntityGreenlightFurnace)par1World.getBlockTileEntity(par2, par3, par4);

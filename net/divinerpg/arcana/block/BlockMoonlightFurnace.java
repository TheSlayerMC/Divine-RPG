...
public class BlockMoonlightFurnace extends BlockContainer
{
    ...
    public BlockMoonlightFurnace(int par1, boolean par2)
    {
    ...
    {
        this.blockIcon = par1IconRegister.registerIcon("DivineRPG:MoonlightFurnace_Side");
        this.furnaceIconFront = par1IconRegister.registerIcon(this.isActive ? "DivineRPG:MoonlightFurnace_On_Front" : "DivineRPG:MoonlightFurnace_Off_Front");
        this.furnaceIconTop = par1IconRegister.registerIcon("DivineRPG:MoonlightFurnace_Top");
    }
    ...
    {
        return ArcanaBlockHelper.moonlightFurnace.blockID;
    }
    ...
    public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9)
    {
        ...
        {
            TileEntityFurnace var10 = (TileEntityMoonlightFurnace)par1World.getBlockTileEntity(par2, par3, par4);
    ...
    public static void updateFurnaceBlockState(boolean par0, World par1World, int par2, int par3, int par4)
    {
        ...
        if (par0)
        {
            par1World.setBlock(par2, par3, par4, ArcanaBlockHelper.moonlightFurnaceOn.blockID);
        }
        else
        {
            par1World.setBlock(par2, par3, par4, ArcanaBlockHelper.moonlightFurnace.blockID);
        }
    ...
    public void breakBlock(World par1World, int par2, int par3, int par4, int par5, int par6)
    {
        ...
        {
            TileEntityFurnace var7 = (TileEntityMoonlightFurnace)par1World.getBlockTileEntity(par2, par3, par4);

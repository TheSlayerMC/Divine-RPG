...
public class BlockMoltenFurnace extends BlockContainer
{
    ...
    public BlockMoltenFurnace(int par1, boolean par2)
    {
    ...
    {
        this.blockIcon = par1IconRegister.registerIcon("DivineRPG:MoltenFurnace_Side");
        this.furnaceIconFront = par1IconRegister.registerIcon(this.isActive ? "DivineRPG:MoltenFurnace_On_Front" : "DivineRPG:MoltenFurnace_Off_Front");
        this.furnaceIconTop = par1IconRegister.registerIcon("DivineRPG:MoltenFurnace_Top");
    }
    ...
    {
        return ArcanaBlockHelper.moltenFurnace.blockID;
    }
    ...
    public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9)
    {
        ...
        {
            TileEntityMoltenFurnace var10 = (TileEntityMoltenFurnace)par1World.getBlockTileEntity(par2, par3, par4);

            if (var10 != null)
            {
                par5EntityPlayer.openGui(DivineRPG.instance, GuiHandler.Molten, par1World, par2, par3, par4);
            }
    ...
    public static void updateFurnaceBlockState(boolean par0, World par1World, int par2, int par3, int par4)
    {
        ...
        if (par0)
        {
            par1World.setBlock(par2, par3, par4, ArcanaBlockHelper.moltenFurnaceOn.blockID);
        }
        else
        {
            par1World.setBlock(par2, par3, par4, ArcanaBlockHelper.moltenFurnaceOn.blockID);
    ...
    public void breakBlock(World par1World, int par2, int par3, int par4, int par5, int par6)
    {
        ...
        {
            TileEntityMoltenFurnace var7 = (TileEntityMoltenFurnace)par1World.getBlockTileEntity(par2, par3, par4);

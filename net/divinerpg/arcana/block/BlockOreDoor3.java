...
public class BlockOreDoor3 extends BlockBase
{
    ...
    public BlockOreDoor3(int par1, Material par2Material)
    {
    ...
    public void registerIcons(IconRegister par1IconRegister)
    {
        ...
        this.field_111044_a[0] = par1IconRegister.registerIcon("DivineRPG:OreDoor3");
        this.field_111043_b[0] = par1IconRegister.registerIcon("DivineRPG:SoulStone");
    ...
    {
        return (par1 & 8) != 0 ? 0 : (this.blockMaterial == Material.iron ? ArcanaItemHelper.OreDoor3.itemID : ArcanaItemHelper.OreDoor3.itemID);
    }
    ...
    {
        return this.blockMaterial == Material.iron ? ArcanaItemHelper.OreDoor3.itemID : ArcanaItemHelper.OreDoor3.itemID;
    }

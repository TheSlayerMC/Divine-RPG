...
public class BlockWhitefireFurnace extends BlockDivineRPGContainer
{
    ...
    {
        this.blockIcon = par1IconRegister.registerIcon("DivineRPG:WhitefireFurnace_Side");
        this.furnaceIconFront = par1IconRegister.registerIcon(this.isActive ? "DivineRPG:WhitefireFurnace_On_Front" : "DivineRPG:WhitefireFurnace_Off_Front");
        this.furnaceIconTop = par1IconRegister.registerIcon("DivineRPG:WhitefireFurnace_Top");
    }
    ...
    public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9)
    {
        ...
        else
        {
            ...
            if (var10 != null)
            {
                par5EntityPlayer.openGui(DivineRPG.instance, GuiHandler.Whitefire, par1World, par2, par3, par4);
            }

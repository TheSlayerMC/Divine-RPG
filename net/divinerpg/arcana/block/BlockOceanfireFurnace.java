...
import net.divinerpg.overworld.block.tileentity.TileEntityOceanfireFurnace;
...
public class BlockOceanfireFurnace extends BlockContainer
{
    ...
    public BlockOceanfireFurnace(int par1, boolean par2)
    {
    ...
    {
        return ArcanaBlockHelper.oceanfireFurnace.blockID;
    }
    ...
    {
        this.blockIcon = par1IconRegister.registerIcon("DivineRPG:OceanfireFurnace_Side");
        this.furnaceIconFront = par1IconRegister.registerIcon(this.isActive ? "DivineRPG:OceanfireFurnace_On_Front" : "DivineRPG:OceanfireFurnace_Off_Front");
        this.furnaceIconTop = par1IconRegister.registerIcon("DivineRPG:OceanfireFurnace_Top");
    }
    ...
    public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9)
    {
        ...
        {
            TileEntityFurnace var10 = (TileEntityOceanfireFurnace)par1World.getBlockTileEntity(par2, par3, par4);

            if (var10 != null)
            {
                par5EntityPlayer.openGui(DivineRPG.instance, GuiHandler.Oceanfire, par1World, par2, par3, par4);
            }
    ...
    public static void updateFurnaceBlockState(boolean par0, World par1World, int par2, int par3, int par4)
    {
        ...
        if (par0)
        {
            par1World.setBlock(par2, par3, par4, ArcanaBlockHelper.oceanfireFurnaceOn.blockID);
        }
        else
        {
            par1World.setBlock(par2, par3, par4, ArcanaBlockHelper.oceanfireFurnace.blockID);
        }
    ...
    public void breakBlock(World par1World, int par2, int par3, int par4, int par5, int par6)
    {
        ...
        {
            TileEntityFurnace var7 = (TileEntityOceanfireFurnace)par1World.getBlockTileEntity(par2, par3, par4);

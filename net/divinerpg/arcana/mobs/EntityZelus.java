...
public class EntityZelus extends EntityVillager implements INpc, IMerchant
{
    ...
    public boolean interact(EntityPlayer var1)
    {
        if (this.isEntityAlive() && !this.isTrading() && !this.isChild())
        {
            if (!this.worldObj.isRemote)
            {
                ...
                var1.openGui(DivineRPG.instance, GuiHandler.ZELUS, this.worldObj, this.entityId, 0, 0);
            }
    ...
    private void addDefaultEquipmentAndRecipies(int var1)
    {
        ...
        var2.add(new MerchantRecipe(new ItemStack(ArcanaItemHelper.arcanium.itemID, 2, 1), new ItemStack(ArcanaItemHelper.fyracryxSpawner.itemID, 1, 0)));
        var2.add(new MerchantRecipe(new ItemStack(ArcanaItemHelper.arcanium.itemID, 2, 1), new ItemStack(ArcanaItemHelper.seimerSpawner.itemID, 1, 0)));
        var2.add(new MerchantRecipe(new ItemStack(ArcanaItemHelper.arcanium.itemID, 3, 1), new ItemStack(ArcanaItemHelper.paratikuSpawner.itemID, 1, 0)));
        var2.add(new MerchantRecipe(new ItemStack(ArcanaItemHelper.arcanium.itemID, 5, 1), new ItemStack(ArcanaItemHelper.golemOfRejuvSpawner.itemID, 1, 0)));

...
public class ItemStarfall  extends ItemsBase
{
    ...
    public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
    {
        ...
        MovingObjectPosition var22 = par2World.clip(var12, var21, false);
        ...
        else
        {
            if (var22.typeOfHit == EnumMovingObjectType.TILE)
            {
                ...
                {
                    par2World.playSoundAtEntity(par3EntityPlayer, Sound.Starlight, 1.0F, 1.0F);

...
import net.divinerpg.helper.base.ItemDivineRPGBucket;
        ...
        else
        {
            ...
            if (var12.typeOfHit == EnumMovingObjectType.TILE)
            {
                ...
                if (this.isFull == 0)
                {
                    ...
                    if (par2World.getBlockMaterial(var13, var14, var15) == Material.lava && par2World.getBlockMetadata(var13, var14, var15) == 0 && par2World.getBlockId(var13, var14, var15) == OverworldBlockHelper.Tar.blockID)
                    {
                ...
                else
                {
                    ...
                    if (this.tryPlaceContainedLiquid(par2World, var13, var14, var15) && !par3EntityPlayer.capabilities.isCreativeMode)
                    {
                        return new ItemStack(ArcanaItemHelper.arcaniumBucket);
                    }
                }

...
import net.divinerpg.item.DivineBow;
...
public class ItemMeriksMissile extends DivineBow
{
    ...
    {	
        ...
        this.itemIcon = par1IconRegister.registerIcon(prefix + "MeriksMissile_0");
        this.iconArray[0] = par1IconRegister.registerIcon(prefix + "MeriksMissile_1");
        this.iconArray[1] = par1IconRegister.registerIcon(prefix + "MeriksMissile_2");
        this.iconArray[2] = par1IconRegister.registerIcon(prefix + "MeriksMissile_3");

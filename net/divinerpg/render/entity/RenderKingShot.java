...
public class RenderKingShot extends Render
{
    public ResourceLocation texture;
    float scale;

    public RenderKingShot(ResourceLocation par1)
    {
        texture = par1;
        scale = 1F;
    }

    public RenderKingShot(ResourceLocation par1, float scaleFactor)
    {
        texture = par1;
        scale = scaleFactor;
    }

    public void renderProjectile(EntityMamormeterShot projectile, double x, double y, double z)
    {
        GL11.glPushMatrix();
    ...
    {
        this.renderProjectile((EntityMamormeterShot)par1Entity, par2, par4, par6);
    }

...
public class RenderDensos extends RenderLivingCreature
{
    protected ModelDensos modelBipedMain;
    protected float field_77070_b;

    public RenderDensos(ModelDensos var1, float var2, ResourceLocation textureLoc)
    {
        this(var1, var2, 1.0F, textureLoc);
    }

    public RenderDensos(ModelDensos var1, float var2, float var3, ResourceLocation textureLoc)
    {

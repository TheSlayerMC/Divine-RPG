...
import net.divinerpg.client.render.model.ModelAridWarrior;
...
public class RenderAridWarrior extends RenderLivingCreature
{
    protected ModelAridWarrior modelBipedMain;
    protected float field_77070_b;

    public RenderAridWarrior(ModelAridWarrior var1, float var3, ResourceLocation texture)
    {
        super(var1, var3, texture);

...
public class RenderFrostArcher extends RenderBipedCreature
{
    protected ModelBiped modelBipedMain;
    protected float field_77070_b;

    public RenderFrostArcher(ModelBiped ModelBiped, float var2, ResourceLocation texutreLoc)
    {
        this(ModelBiped, var2, 1.0F, texutreLoc);
    }

    public RenderFrostArcher(ModelBiped ModelBiped, float var2, float var3, ResourceLocation texutreLoc)
    {
        super(ModelBiped, var2 * var3, texutreLoc); 

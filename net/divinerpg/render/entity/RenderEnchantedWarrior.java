...
public class RenderEnchantedWarrior extends RenderLivingCreature
{
    protected ModelEnchantedWarrior modelBipedMain;
    protected float field_77070_b;

    public RenderEnchantedWarrior(ModelEnchantedWarrior var1, float var2, ResourceLocation textureLoc)
    {
        this(var1, var2, 1.0F, textureLoc);
        this.modelBipedMain = var1;
    }

    public RenderEnchantedWarrior(ModelEnchantedWarrior var1, float var2, float var3, ResourceLocation textureLocation)
    {

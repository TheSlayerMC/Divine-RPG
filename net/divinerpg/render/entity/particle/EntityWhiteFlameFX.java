package net.divinerpg.render.entity.particle;
...
public class EntityWhiteFlameFX extends EntityFX
{
    ...
    public EntityWhiteFlameFX(World var1, double var2, double var4, double var6, double var8, double var10, double var12)
    {
        ...
        double var10000 = var2 + (this.rand.nextFloat() - this.rand.nextFloat()) * 0.05F;
        var10000 = var4 + (this.rand.nextFloat() - this.rand.nextFloat()) * 0.05F;
        var10000 = var6 + (this.rand.nextFloat() - this.rand.nextFloat()) * 0.05F;

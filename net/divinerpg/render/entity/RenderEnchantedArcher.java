...
public class RenderEnchantedArcher extends RenderLivingCreature
{
    protected ModelEnchantedArcher modelBipedMain;
    protected float field_77070_b;

    public RenderEnchantedArcher(ModelEnchantedArcher var1, float var2, ResourceLocation textureLoc)
    {
        this(var1, var2, 1.0F, textureLoc);
        this.modelBipedMain = var1;
    }

    public RenderEnchantedArcher(ModelEnchantedArcher var1, float var2, float var3, ResourceLocation textureLocation)
    {
        super(var1, var2, textureLocation);
        this.modelBipedMain = var1;
    ...
    protected void renderEquippedItems(EntityLivingBase var1, float var2)
    {
        ...
        if (var3 != null)
        {
            ...
            else if (var3.itemID == TwilightItemHelper.UviteBow.itemID)
            {
                var4 = 1.00F;
                GL11.glTranslatef(-0.6F, 0.125F, 0.3125F);
                GL11.glRotatef(-20.0F, 0.0F, 1.0F, 0.0F);

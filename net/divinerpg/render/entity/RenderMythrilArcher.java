...
public class RenderMythrilArcher extends RenderLivingCreature
{
    protected ModelEnchantedArcher modelBipedMain;
    protected float field_77070_b;

    public RenderMythrilArcher(ModelEnchantedArcher var1, float var2, ResourceLocation textureLoc)
    {
        this(var1, var2, 1.0F, textureLoc);
        this.modelBipedMain = var1;
    }

    public RenderMythrilArcher(ModelEnchantedArcher var1, float var2, float var3, ResourceLocation textureLoc)
    {
    ...
    protected void renderEquippedItems(EntityLivingBase var1, float var2)
    {
        ...
        if (var3 != null)
        {
            ...
            else if (var3.itemID == TwilightItemHelper.MythrilBow.itemID)
            {
                var4 = 1.00F;
                GL11.glTranslatef(-0.6F, 0.125F, 0.3125F);
                GL11.glRotatef(-20.0F, 0.0F, 1.0F, 0.0F);

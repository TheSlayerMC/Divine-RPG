...
public class ModelPhoenixAltar extends ModelBase
{
    ...
    public ModelPhoenixAltar(float scale)
    {
        this.f5 = scale;
        textureWidth = 64;
        textureHeight = 32;

...
public class RenderTripletShot extends Render
{
    public ResourceLocation texture;
    float scale;

    public RenderTripletShot(ResourceLocation par1, float scaleFactor)
    {
        texture = par1;
        scale = scaleFactor;
    }

    public void renderProjectile(EntityFireball projectile, double x, double y, double z)
    {
        GL11.glPushMatrix();
    ...
    {
        this.renderProjectile((EntityFireball)par1Entity, par2, par4, par6);
    }

...
public class GuiLeorna extends GuiContainer
{
    ...
    public GuiLeorna(ContainerDivineMerchant container)
    {
        super(container);
	...
	public void initGui()
    {
        ...
        this.buttonList.add(this.nextRecipeButtonIndex = new ModGuiMerchantButton(1, var1 + 120 + 27, var2 + 24 - 1, true, ResourceGuiLoc.GUI_LEORNA));
        this.buttonList.add(this.previousRecipeButtonIndex = new ModGuiMerchantButton(2, var1 + 36 - 19, var2 + 24 - 1, false, ResourceGuiLoc.GUI_LEORNA));
    ...
    protected void drawGuiContainerBackgroundLayer(float var1, int var2, int var3)
    {
        ...
        mc.getTextureManager().bindTexture(ResourceGuiLoc.GUI_LEORNA);

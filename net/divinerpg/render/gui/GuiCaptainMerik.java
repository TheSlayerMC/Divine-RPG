...
public class GuiCaptainMerik extends GuiContainer
{
	...
	public void initGui()
    {
        ...
        this.buttonList.add(this.nextRecipeButtonIndex = new ModGuiMerchantButton(1, var1 + 120 + 27, var2 + 24 - 1, true, ResourceGuiLoc.GUI_MERIK));
        this.buttonList.add(this.previousRecipeButtonIndex = new ModGuiMerchantButton(2, var1 + 36 - 19, var2 + 24 - 1, false, ResourceGuiLoc.GUI_MERIK));
    ...
    protected void drawGuiContainerBackgroundLayer(float var1, int var2, int var3)
    {
        ...
        mc.getTextureManager().bindTexture(ResourceGuiLoc.GUI_MERIK);

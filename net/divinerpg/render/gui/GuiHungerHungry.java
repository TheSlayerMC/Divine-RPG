...
public class GuiHungerHungry extends GuiContainer
{
    ...
    public GuiHungerHungry(ContainerDivineMerchant container) 
    {
        super(container);
	...
	public void initGui()
    {
        ...
        this.buttonList.add(this.nextRecipeButtonIndex = new ModGuiMerchantButton(1, var1 + 120 + 27, var2 + 24 - 1, true, ResourceGuiLoc.GUI_HUNGER));
        this.buttonList.add(this.previousRecipeButtonIndex = new ModGuiMerchantButton(2, var1 + 36 - 19, var2 + 24 - 1, false, ResourceGuiLoc.GUI_HUNGER));
    ...
    {
        this.fontRenderer.drawString(StatCollector.translateToLocal("Hunger Hungry"), 56, 6, 4210752);
    ...
    protected void drawGuiContainerBackgroundLayer(float var1, int var2, int var3)
    {
        ...
        mc.getTextureManager().bindTexture(ResourceGuiLoc.GUI_HUNGER);
    ...
    public void drawScreen(int var1, int var2, float var3)
    {
        ...
        if (var4 != null && !var4.isEmpty())
        {
            ...
            {
                GL11.glBindTexture(GL11.GL_TEXTURE_2D, mc.renderEngine.getTexture(ResourceGuiLoc.GUI_TRADING).getGlTextureId());
                GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);

...
import net.divinerpg.block.container.ContainerCondenser;
import net.divinerpg.lib.ResourceGuiLoc;
import net.divinerpg.overworld.block.tileentity.TileEntityCondenser;
...
public class GuiCondenser extends GuiContainer
{
    ...
    protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3)
    {
        ...
        mc.getTextureManager().bindTexture(ResourceGuiLoc.GUI_CONDENSER);
        ...
        if (var7 > 0)
        {
            int var8 = (int)(28.0F * (1.0F - var7 / 400.0F));

...
public class GuiDatticon extends GuiContainer
{
    ...
    public GuiDatticon(ContainerDivineMerchant container)
    {
        super(container);
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(this.nextRecipeButtonIndex = new ModGuiMerchantButton(1, i + 120 + 27, j + 24 - 1, true, ResourceGuiLoc.GUI_DATTICON));
        this.buttonList.add(this.previousRecipeButtonIndex = new ModGuiMerchantButton(2, i + 36 - 19, j + 24 - 1, false, ResourceGuiLoc.GUI_DATTICON));
    ...
    protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3)
    {
        ...
        this.mc.getTextureManager().bindTexture(ResourceGuiLoc.GUI_DATTICON);

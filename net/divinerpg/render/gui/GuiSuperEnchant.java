...
import net.divinerpg.block.container.ContainerSuperEnchant;
...
public class GuiSuperEnchant extends GuiContainer
{
    ...
    protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3)
    {
        ...
        mc.getTextureManager().bindTexture(ResourceGuiLoc.GUI_ENCHANT);
        ...
        mc.getTextureManager().bindTexture(ResourceGuiLoc.ITEM_BOOK);

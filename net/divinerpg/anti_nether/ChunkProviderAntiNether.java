...
public class ChunkProviderAntiNether implements IChunkProvider
{
     ...
     */
    private NoiseGeneratorOctaves iceExculsivityNoiseGen;
    ...
    /**
     * Holds the noise used to determine whether something other than ice can be generated at a location
     */
    private double[] iceExclusivityNoise = new double[256];
    private MapGenBase netherCaveGenerator = new MapGenCavesAntiNether();
    double[] noiseData1;
    double[] noiseData2;
    double[] noiseData3;
    double[] noiseData4;
    ...
    public ChunkProviderAntiNether(World par1World, long par2)
    {
        ...
        this.iceExculsivityNoiseGen = new NoiseGeneratorOctaves(this.hellRNG, 4);
        this.netherNoiseGen6 = new NoiseGeneratorOctaves(this.hellRNG, 10);
        this.netherNoiseGen7 = new NoiseGeneratorOctaves(this.hellRNG, 16);

        NoiseGeneratorOctaves[] noiseGens = {netherNoiseGen1, netherNoiseGen2, netherNoiseGen3, slowsandGravelNoiseGen, iceExculsivityNoiseGen, netherNoiseGen6, netherNoiseGen7};
        ...
        this.iceExculsivityNoiseGen = noiseGens[4];
    ...
    public void replaceBlocksForBiome(int par1, int par2, byte[] par3ArrayOfByte)
    {
        ...
        this.iceExclusivityNoise = this.iceExculsivityNoiseGen.generateNoiseOctaves(this.iceExclusivityNoise, par1 * 16, par2 * 16, 0, 16, 16, 1, d0 * 2.0D, d0 * 2.0D, d0 * 2.0D);
        ...
        for (int k = 0; k < 16; ++k)
        {
            for (int l = 0; l < 16; ++l)
            {
                ...
                int i1 = (int)(this.iceExclusivityNoise[k + l * 16] / 3.0D + 3.0D + this.hellRNG.nextDouble() * 0.25D);
                int j1 = -1;
                byte b1 = (byte)Block.ice.blockID;
                byte b2 = (byte)Block.ice.blockID;
    ...
    public void populate(IChunkProvider par1IChunkProvider, int par2, int par3)
    {
        ...
        boolean doGen = TerrainGen.populate(par1IChunkProvider, worldObj, hellRNG, par2, par3, false, ICE);
        for (i1 = 0; doGen && i1 < 8; ++i1)
        {
            j1 = k + this.hellRNG.nextInt(16) + 8;
            k1 = this.hellRNG.nextInt(120) + 4;
            l1 = l + this.hellRNG.nextInt(16) + 8;
            (new WorldGenHellLava(Block.waterMoving.blockID, false)).generate(this.worldObj, this.hellRNG, j1, k1, l1);
        }
        ...
        WorldGenMinable worldgenminable = new WorldGenMinable(Block.ice.blockID, 13, Block.ice.blockID);//first param is the ore gen
        int j2;
        ...
        for (k1 = 0; k1 < 16; ++k1)
        {
            ...
            i2 = this.hellRNG.nextInt(108) + 10;
            j2 = l + this.hellRNG.nextInt(16);
            (new WorldGenHellLava(Block.waterMoving.blockID, true)).generate(this.worldObj, this.hellRNG, l1, i2, j2);
        }

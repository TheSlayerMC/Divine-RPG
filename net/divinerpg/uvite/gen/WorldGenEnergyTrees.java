...
public class WorldGenEnergyTrees extends WorldGenerator
{
     ...
     */
    static final int[] otherCoordPairs = new int[] {(int)2, (int)0, (int)0, (int)1, (int)2, (int)1};
    ...
    public WorldGenEnergyTrees(boolean par1)
    {
        super(par1);
    }
    ...
    void genTreeLayer(int par1, int par2, int par3, float par4, int par5, int par6)
    {
        int var7 = (int)((double)par4 + 0.618D);
        int var8 = otherCoordPairs[par5];
        int var9 = otherCoordPairs[par5 + 3];
    ...
    void generateTrunk()
    {
        ...
        this.placeBlockLine(var5, var6, TwilightBlockHelper.uviteLog.blockID);
    ...
    void generateLeafNodeBases()
    {
        ...
        for (int[] var3 = new int[] {this.basePos[0], this.basePos[1], this.basePos[2]}; var1 < var2; ++var1)
        {
            ...
            {
                this.placeBlockLine(var3, var5, (int)TwilightBlockHelper.uviteLog.blockID);
            }
        }
    }

...
public class BlockAzuriteVine extends Block implements IShearable
{
	String Name;
	public BlockAzuriteVine(int par1, String name)
	{
	...
	public void registerIcons(IconRegister icon) {
		blockIcon = icon.registerIcon(Reference.MOD_ID + ":" + Name + "Vine");
	}

...
public class EntityFuryArrow extends Entity
{
    ...
    public EntityFuryArrow(World world, double var2, double var4, double var6)
    {
        super(world);
        this.setSize(0.5F, 0.5F);
    ...
    public EntityFuryArrow(World var1, EntityLivingBase thrower, EntityLivingBase entity, float var4, float var5)
    {
        super(var1);
    ...
    public EntityFuryArrow(World var1, EntityLivingBase entity, float var3)
    {
        super(var1);
    ...
    public void onCollideWithPlayer(EntityPlayer var1)
    {
        if (!this.worldObj.isRemote && this.inGround && this.arrowShake <= 0)
        {
            ...
            if (this.canBePickedUp == 1 && !var1.inventory.addItemStackToInventory(new ItemStack(OverworldItemHelper.furyArrow, 1)))
            {
                var2 = false;
            }

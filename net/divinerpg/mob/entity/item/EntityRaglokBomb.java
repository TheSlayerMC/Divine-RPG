...
public class EntityRaglokBomb extends Entity
{
    ...
    public EntityRaglokBomb(World var1, double var2, double var4, double var6, boolean b)
    {
        super(var1);
        this.setSize(0.5F, 0.5F);
    ...
    public EntityRaglokBomb(World world, EntityLivingBase entityUser, EntityLivingBase targetEntity, float var4, float var5, boolean b)
    {
        super(world);
        this.shootingEntity = entityUser;
        ...
        this.posY = entityUser.posY + entityUser.getEyeHeight() - 0.10000000149011612D;
        double var6 = targetEntity.posX - entityUser.posX;
        double var8 = targetEntity.posY + targetEntity.getEyeHeight() - 0.699999988079071D - this.posY;
        double var10 = targetEntity.posZ - entityUser.posZ;
        ...
        if (var12 >= 1.0E-7D)
        {
            ...
            this.setLocationAndAngles(entityUser.posX + var16, this.posY, entityUser.posZ + var18, var14, var15);
            this.yOffset = 0.0F;
    ...
    public EntityRaglokBomb(World world, EntityLivingBase entity, float var3)
    {
        super(world);
        ...
        else
        {
            ...
            if (var4 != null)
            {
                if (var4.entityHit != null)
                {
                    ...
                    var21 = MathHelper.ceiling_double_int(var20 * this.damage);

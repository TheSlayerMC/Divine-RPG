...
public class EntityMerikMissile extends EntityThrowable implements IProjectile
{
    ...
    public EntityMerikMissile(World par1World, EntityLiving par2EntityLiving, float par3, int par4)
    {
        super(par1World);
        this.age = par4;
    ...
    public void onUpdate()
    {
        ...
        MovingObjectPosition var3 = this.worldObj.clip(var16, var2); // Rayrace against all blocks - liquids.
        ...
        if (this.isInWater())
        {
            ...
            {
                float var20 = 0.25F;
                this.worldObj.spawnParticle("bubble", this.posX - this.motionX * var20, this.posY - this.motionY * var20, this.posZ - this.motionZ * var20, this.motionX, this.motionY, this.motionZ);
            }

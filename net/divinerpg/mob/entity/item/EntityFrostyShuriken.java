        ...
        if (!this.worldObj.isRemote)
        {
            ...
            for (int var9 = 0; var9 < var5.size(); ++var9)
            {
                ...
                if (var10.canBeCollidedWith() && (var10 != var8))
                {
                    ...
                    if (var13 != null)
                    {
                        if(var10 !=this.getThrower() && var10 instanceof EntityLiving)
                        {
                            if(var10.posX < this.getThrower().posX + 5 || var10.posX > this.getThrower().posX - 5 || var10.posZ < this.getThrower().posZ + 5 || var10.posZ > this.getThrower().posZ - 5)
                            {

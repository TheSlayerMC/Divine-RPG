...
public class WorldGenAzuriteTrees extends WorldGenerator
{
            ...
            else
            {
                ...
                if ((var8 == TwilightBlockHelper.AzuriteGrass.blockID || var8 == TwilightBlockHelper.AzuriteDirt.blockID) && var4 < 128 - var6 - 1)
                {
                    ...
                    for (var13 = 0; var13 < var6; ++var13)
                    {
                        ...
                        {
                            this.setBlock(var1, var3, var4 + var13, var5, TwilightBlockHelper.AzuriteLog.blockID);
                        }
                    }
    ...
    {
        this.setBlockAndMetadata(var1, var2, var3, var4, TwilightBlockHelper.azuriteVine.blockID, var5);
        int var6 = 4;
